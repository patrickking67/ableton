...
Skills also auto-trigger from natural language, such as "review my track", "write a bassline", or "what should this sound like." No slash is needed.
...
## Connectors (6 bundled MCP servers)
...
Local Ableton control is configured separately. See [CONNECTORS.md](CONNECTORS.md#1-ableton-mcp).
...
Or just describe what you want, such as "make me a 4-bar bassline in F minor, drop it into the active clip," and it will route to the right skill.
